...
public class Pregunta 
{
	...
	/**
	 * Guarda cada una de las l�neas del �rbol que contiene la informaci�n de los nodos
	 */
	...
	/**
	 * Devuelve la �ndide de la l�nea que contine el nodo nodoActual. Ejemplo N0 [label="mujer" ]
	 * @param lineas
	 * @return
	 */
	...
	/**
	 * devuelve el contenido almacenado en label en la l�nea pasada como argumento
	 * @param linea
	 * @return
	 */
	...
	/**
	 * Navega desde nodoActual al nodo correspondiente en funci�n de la respuesta del usuario.
	 * No se hace ning�n tipo de valiaci�n aunque s�lo se permite contesar s o n por los datos del csv 
	 * pero no se restringe por si se hiciera otro ejemplo.
	 * Ejemplo de nodo navegaci�n N0->N1 [label="= n"]
	 * @param respuesta 
	 */
